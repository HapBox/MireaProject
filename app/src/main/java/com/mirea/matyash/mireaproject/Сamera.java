...
public class Сamera extends Fragment implements View.OnClickListener {

    private static final int REQUEST_CODE_PERMISSION_CAMERA = 100;
    private static final String TAG = Сamera.class.getSimpleName();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        Log.d(Сamera.TAG, imageUri.getSchemeSpecificPart());
    ...
    public void onClick(View v) {
        ...
        if (cameraIntent.resolveActivity(getActivity().getPackageManager()) != null && isWork)
        {
            ...
            imageUri = FileProvider.getUriForFile(getContext(), "com.mirea.matyash.mireaproject.fileprovider", photoFile);
            cameraIntent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
            startActivityForResult(cameraIntent, Сamera.CAMERA_REQUEST);
        }
    }
}